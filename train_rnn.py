...
from data_rnn import get_dataloader
from model_rnn import Surge
from utils import EarlyStopping, Config, init_random_state
from tqdm import tqdm
from torch.utils.tensorboard import SummaryWriter

parser = argparse.ArgumentParser(description='args')
parser.add_argument('--config_path', type=str, default='config_rnn.yaml')
...
def main():
    ...
    data_folder = '/data/home/hejiansu/KT/xiangwei/surge_pytorch/data/origin'
    ...
    if not args.infer:
        ...
        # Early stop
        stopper = EarlyStopping(patience=7, path='surge_dkt_skill.ckpt')
    ...
    # Test
    model.load_state_dict(torch.load('surge_dkt_skill.ckpt'))
